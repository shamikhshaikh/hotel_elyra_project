        ...
        <div class="row justify-content-center">
            <div class="col-lg-8">
                <div class="d-flex justify-content-between align-items-center mb-4">
                    <h1 class="display-6 fw-bold" style="font-family: var(--font-primary); color: var(--current-gold);">Add New Booking</h1>
                        ...
                        <form action="{{ route('admin.bookings.store') }}" method="POST">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control" name="guest_phone" value="{{ old('guest_phone') }}" required
                                        style="background: var(--current-primary); border: 1px solid var(--current-accent); color: var(--current-text);">
                                </div>
                            </div>
                            ...
                            <div class="row mb-4">
                                <div class="col-md-4">
                                    ...
                                    <input type="number" class="form-control" name="guests" value="{{ old('guests', 1) }}" min="1" required
                                        style="background: var(--current-primary); border: 1px solid var(--current-accent); color: var(--current-text);">
                                </div>
                                <div class="col-md-4">
                                    <label class="form-label" style="color: var(--current-text-light);">Total Price ($)</label>
                                    <input type="number" step="0.01" class="form-control" name="total_price" value="{{ old('total_price') }}" required
                                        style="background: var(--current-primary); border: 1px solid var(--current-accent); color: var(--current-text);">
                                </div>
                                <div class="col-md-4">
